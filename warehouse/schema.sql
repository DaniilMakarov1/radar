...
CREATE TABLE IF NOT EXISTS dune_executions (
...
CREATE TABLE IF NOT EXISTS prediction_scans (
    prediction_scan_id INTEGER PRIMARY KEY AUTOINCREMENT,
    status TEXT NOT NULL,
    started_at TEXT NOT NULL,
    finished_at TEXT,
    ...
    executable_route_count INTEGER NOT NULL DEFAULT 0,
    config_json TEXT NOT NULL DEFAULT '{}',
    error TEXT
);

CREATE INDEX IF NOT EXISTS idx_prediction_scans_started
    ON prediction_scans (started_at DESC);
...
CREATE TABLE IF NOT EXISTS prediction_events (
    ...
    augmented_neg_risk INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_prediction_events_active
    ON prediction_events (venue, active, closes_at);
...
CREATE TABLE IF NOT EXISTS prediction_markets (
    ...
    is_other_outcome INTEGER NOT NULL DEFAULT 0,
    observed_at TEXT NOT NULL,
    raw_json TEXT NOT NULL DEFAULT '{}',
    updated_at TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_prediction_markets_event
    ON prediction_markets (venue, event_id, status);

CREATE TABLE IF NOT EXISTS prediction_orderbook_snapshots (
    prediction_orderbook_snapshot_id INTEGER PRIMARY KEY AUTOINCREMENT,
    prediction_scan_id INTEGER NOT NULL,
    venue TEXT NOT NULL,
    market_id TEXT NOT NULL,
    observed_at TEXT NOT NULL,
    yes_bids_json TEXT NOT NULL DEFAULT '[]',
    yes_asks_json TEXT NOT NULL DEFAULT '[]',
    no_bids_json TEXT NOT NULL DEFAULT '[]',
    no_asks_json TEXT NOT NULL DEFAULT '[]',
    best_yes_bid REAL,
    best_yes_ask REAL,
    best_no_bid REAL,
    best_no_ask REAL,
    ...
    UNIQUE (prediction_scan_id, venue, market_id)
);

CREATE INDEX IF NOT EXISTS idx_prediction_books_market
    ON prediction_orderbook_snapshots (venue, market_id, observed_at DESC);

CREATE TABLE IF NOT EXISTS prediction_constraints (
    prediction_constraint_id INTEGER PRIMARY KEY AUTOINCREMENT,
    prediction_scan_id INTEGER NOT NULL,
    venue TEXT NOT NULL,
    antecedent_market_id TEXT NOT NULL,
    consequent_market_id TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS prediction_contract_matches (
    prediction_contract_match_id INTEGER PRIMARY KEY AUTOINCREMENT,
    prediction_scan_id INTEGER NOT NULL,
    ...
    status TEXT NOT NULL,
    deadline_delta_hours REAL,
    cancellation_match INTEGER NOT NULL DEFAULT 0,
    rationale_json TEXT NOT NULL DEFAULT '[]',
    risk_flags_json TEXT NOT NULL DEFAULT '[]',
    evidence_json TEXT NOT NULL DEFAULT '{}',
    created_at TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS prediction_routes (
    ...
    guaranteed_payout_per_share REAL NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS idx_prediction_routes_executable
    ON prediction_routes (
        prediction_scan_id,
        status,
...
CREATE TABLE IF NOT EXISTS prediction_paper_executions (
    ...
    prediction_route_id INTEGER NOT NULL,
    prediction_scan_id INTEGER NOT NULL,
    model_version TEXT NOT NULL,
    status TEXT NOT NULL,
    created_at TEXT NOT NULL,
    ...
    depth_haircut REAL NOT NULL,
    queue_ahead_size REAL NOT NULL DEFAULT 0,
    expected_net_profit REAL,
    simulated_net_profit REAL,
    simulated_fees REAL NOT NULL DEFAULT 0,
    simulated_slippage REAL NOT NULL DEFAULT 0,
    capital_required REAL,
    legs_json TEXT NOT NULL DEFAULT '[]',
    result_json TEXT NOT NULL DEFAULT '{}',
    FOREIGN KEY (prediction_route_id)
        REFERENCES prediction_routes(prediction_route_id),
    FOREIGN KEY (prediction_scan_id)
        REFERENCES prediction_scans(prediction_scan_id),
    UNIQUE (prediction_route_id, model_version)
);

CREATE INDEX IF NOT EXISTS idx_prediction_paper_created
    ON prediction_paper_executions (created_at DESC);

CREATE TABLE IF NOT EXISTS prediction_wallet_positions (
    venue TEXT NOT NULL,
    wallet_address TEXT NOT NULL,
    ...
    raw_json TEXT NOT NULL DEFAULT '{}',
    observed_at TEXT NOT NULL,
    PRIMARY KEY (venue, wallet_address, asset_id)
);

CREATE INDEX IF NOT EXISTS idx_prediction_wallet_positions_wallet
    ON prediction_wallet_positions (venue, wallet_address, closed_at DESC);

CREATE TABLE IF NOT EXISTS prediction_wallet_scores (
    venue TEXT NOT NULL,
    wallet_address TEXT NOT NULL,
    model_version TEXT NOT NULL,
    user_name TEXT,
    ...
    observed_at TEXT NOT NULL,
    updated_at TEXT NOT NULL,
    PRIMARY KEY (venue, wallet_address, model_version)
);

CREATE INDEX IF NOT EXISTS idx_prediction_wallet_scores_quality
    ON prediction_wallet_scores (
        model_version,
        quality_score DESC,
        confidence_score DESC
    );

CREATE TABLE IF NOT EXISTS prediction_event_token_links (
    prediction_event_token_link_id INTEGER PRIMARY KEY AUTOINCREMENT,
    venue TEXT NOT NULL,
    event_id TEXT NOT NULL,
    token_id INTEGER NOT NULL,
    chain_id TEXT,
    ...
    FOREIGN KEY (token_id) REFERENCES tokens(token_id),
    FOREIGN KEY (chain_id) REFERENCES chains(chain_id),
    UNIQUE (venue, event_id, token_id, relation_type, source)
);

CREATE INDEX IF NOT EXISTS idx_prediction_token_links_event
    ON prediction_event_token_links (venue, event_id, confidence_score DESC);
