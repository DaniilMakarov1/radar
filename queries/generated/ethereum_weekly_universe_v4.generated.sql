-- Smart Money Radar Research Validity V4
-- Weekly point-in-time universe for ethereum; one row is one token-week.
...
WITH token_flows AS (
    ...
    WHERE d.blockchain = 'ethereum'
      AND d.block_month >= DATE '2018-01-01'
      AND d.block_time >= TIMESTAMP '2018-01-01 00:00:00'
